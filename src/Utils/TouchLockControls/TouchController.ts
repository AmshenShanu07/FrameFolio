...
class TouchLockControlsCore extends EventDispatcher {
  ...
  constructor(camera: Camera, domElement: HTMLElement,speed?:number, maxPolarAngle?:number, minPolarAngle?:number) {
    super();
  ...
  onTouchMove(e: TouchEvent) {
    ...
    this.updatePosition(movementX, movementY, this.speed);
